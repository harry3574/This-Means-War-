...
from constants import UNICODE_FONT, render_text_with_fallback
...
def profile_selection_menu(screen):
    """Menu for selecting a profile."""
    ...
    while True:
        screen.fill(WHITE)
        draw_text(screen, "Select a Profile:", font, BLACK, WIDTH // 2 - 100, 100)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_UP:
                    ...
                    return profiles[selected_option][0]
                elif event.key == pygame.K_ESCAPE:
                    return None
                ...
                if delete_mode:
                    ...
                    if event.key == pygame.K_UP:
                        ...
                        if selected_option == 0:  # Create New Profile
                            ...
                            if profiles:
                                selected_profile = profiles[selected_option - 1]
                                main_menu(selected_profile[0])
